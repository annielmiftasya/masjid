                    ...
                    <div id="content">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-lg">
                                    <h2 class="my-3">
                                        Form Edit Data Dana Infaq Offline
                                        Offline
                                    </h2>
                                    <form
...
export default {
    ...
    methods: {
        ...
        getPhoto() {
            let photo =
                this.form.bukti.length > 100
                    ? this.form.bukti
                    : "Uangmasuk/" + this.form.bukti;
            return photo;
        },
        //Insert Photo
        update() {
            ...
            axios
                .post(
                    `http://localhost:8000/api/admin/uang_masuk/${this.$route.params.id}`,
                    // Code Baru
                    formData,
                    {
                        headers: {
                ...
                .then((response) => {
                    ...
                    if (response.data.status === "success") {
                        ...
                        alert("Data Dana Infaq Offline Berhasil Disimpan!");
                    } else {
                        console.error("fail");
                        alert("Data Dana Infaq Offline Gagal Disimpan!");
                    }
                });
        },
        getData() {
    ...
    beforeMount() {
        ...
        axios
            .get(
                `http://localhost:8000/api/admin/uang_masuk/detail/${this.$route.params.id}`
            )
            .then((response) => {
