...
export default {
    ...
    setup() {
        ...
        onMounted(() => {
            ...
            axios
                .get(
                    `http://localhost:8000/api/admin/uang_masuk/detail/${route.params.id}`
                )
                .then((response) => {
                    uang_masuk.nominal = response.data.data.nominal;
                    uang_masuk.keterangan = response.data.data.keterangan;
                    uang_masuk.bukti = response.data.data.bukti;
                    uang_masuk.date = response.data.data.date;
                })
                .catch((error) => {
